...
| Codex Observability | Monitor Codex sessions, turns, token and cache usage, estimated cost, latency, tools, MCP activity, approvals, errors, logs, and traces. | SQL | 47 | 9 | 6 | [JSON](codex-observability/codex-observability-sql.json) | [Raw](https://raw.githubusercontent.com/parseablehq/dashboards/main/codex-observability/codex-observability-sql.json) |
| OpenRouter Observability | Monitor OpenRouter requests, routing, reliability, provider attempts, retries, latency, tokens, cache usage, cost, models, and traces. | SQL | 40 | 7 | 5 | [JSON](openrouter-observability/openrouter-observability-sql.json) | [Raw](https://raw.githubusercontent.com/parseablehq/dashboards/main/openrouter-observability/openrouter-observability-sql.json) |
...
| Redis Monitoring | Monitor Redis availability, clients, command throughput, memory, keyspace, persistence, replication, network, CPU, logs, traces, and exporter health. | Mixed | 57 | 8 | 6 | [JSON](redis-monitoring/redis-monitoring-mixed.json) | [Raw](https://raw.githubusercontent.com/parseablehq/dashboards/main/redis-monitoring/redis-monitoring-mixed.json) |
| SQL Server Monitoring | Monitor Microsoft SQL Server availability, batch requests, buffer cache, memory, database I/O, TempDB, locks, waits, deadlocks, query logs, traces, and metric inventory. | Mixed | 53 | 8 | 6 | [JSON](sql-server-monitoring/sql-server-monitoring-mixed.json) | [Raw](https://raw.githubusercontent.com/parseablehq/dashboards/main/sql-server-monitoring/sql-server-monitoring-mixed.json) |
| Windows Server Monitoring | Monitor Windows Server host availability, CPU, memory, disk, network, TCP, services, processes, Windows events, traces, and exporter health. | Mixed | 62 | 9 | 8 | [JSON](windows-server-monitoring/windows-server-monitoring-mixed.json) | [Raw](https://raw.githubusercontent.com/parseablehq/dashboards/main/windows-server-monitoring/windows-server-monitoring-mixed.json) |
| MySQL Monitoring | Monitor MySQL availability, connections, query throughput, InnoDB storage, locks, table and index I/O, query performance, logs, traces, and telemetry health. | Mixed | 60 | 10 | 6 | [JSON](mysql-monitoring/mysql-monitoring-mixed.json) | [Raw](https://raw.githubusercontent.com/parseablehq/dashboards/main/mysql-monitoring/mysql-monitoring-mixed.json) |
